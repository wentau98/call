...
// 方法签名严格对应 WebRTC.framework 中 RTCPeerConnectionDelegate 协议（@required 部分）。
extension WebRTCClient: RTCPeerConnectionDelegate {

    /** 信令状态变化（@required）*/
    func peerConnection(_ peerConnection: RTCPeerConnection,
                        didChangeSignalingState newState: RTCSignalingState) {}

    /** 添加了远端 MediaStream（旧 API，@required，UnifiedPlan 下通常不会触发）*/
    func peerConnection(_ peerConnection: RTCPeerConnection,
                        didAdd stream: RTCMediaStream) {}

    /** 移除了远端 MediaStream（@required）*/
    func peerConnection(_ peerConnection: RTCPeerConnection,
                        didRemove stream: RTCMediaStream) {}

    /** ICE 连接状态变化（@required）—— 通话建立/断开核心信号 */
    func peerConnection(_ peerConnection: RTCPeerConnection,
    ...
    /** 添加了远端 RtpReceiver（@optional）—— UnifiedPlan 模式下用这个拿远端 track */
    func peerConnection(_ peerConnection: RTCPeerConnection,
